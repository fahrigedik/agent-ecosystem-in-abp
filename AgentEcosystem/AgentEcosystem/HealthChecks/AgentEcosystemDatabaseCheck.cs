...
public class AgentEcosystemDatabaseCheck : IHealthCheck, ITransientDependency
{
    protected readonly IIdentityRoleRepository IdentityRoleRepository;

    public AgentEcosystemDatabaseCheck(IIdentityRoleRepository identityRoleRepository)
    {
